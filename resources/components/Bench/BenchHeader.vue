            ...
            <div v-else class="flex items-center gap-x-4">
              <div class="relative flex items-center">
                ...
                <div 
                  ...
                  class="absolute right-0 z-50 mt-84 w-80 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                  role="menu"
              ...
              <div class="relative flex items-center">
                ...
                <div 
                  ...
                  class="absolute right-0 z-50 mt-42 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                  role="menu"
                  aria-orientation="vertical"
