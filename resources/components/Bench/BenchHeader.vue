<template>
    <header class="absolute inset-x-0 top-0 z-50">
      <nav class="mx-auto flex items-center justify-between p-6 lg:px-8 border-b border-gray-200 bg-white" aria-label="Global">
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <div class="py-6">
                ...
                <router-link v-if="!isAuthenticated" to="/login" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Log in</router-link>
                <div v-else class="flex items-center gap-x-4 px-3 py-2.5">
                  <div class="relative">
                    <button 
                      type="button" 
                      class="text-gray-400 hover:text-gray-500"
