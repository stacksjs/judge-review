    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="mt-8 flex justify-center">
        <div class="flex items-center gap-x-4">
          <span :class="['text-sm font-medium', pricingPeriod === 'monthly' ? 'text-gray-800' : 'text-gray-600']">Monthly</span>
          <button
            type="button"
            ...
            :class="pricingPeriod === 'yearly' ? 'bg-gray-600' : 'bg-gray-200'"
            @click="togglePricingPeriod"
          >
            <span
          ...
          <span :class="['text-sm font-medium', pricingPeriod === 'yearly' ? 'text-gray-800' : 'text-gray-600']">Yearly</span>
        </div>
      </div>
      ...
      <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 md:max-w-2xl md:grid-cols-2">
        <div class="rounded-3xl p-8 ring-1 ring-gray-200">
          ...
          <p class="mt-6 flex items-baseline gap-x-1">
            ...
            <span class="text-sm/6 font-semibold text-gray-600">/{{ pricingPeriod === 'monthly' ? 'month' : 'year' }}</span>
          </p>
        ...
        <div class="rounded-3xl p-8 ring-2 ring-gray-600">
          ...
          <p class="mt-6 flex items-baseline gap-x-1">
            <span class="text-4xl font-semibold tracking-tight text-gray-800">${{ pricingPeriod === 'monthly' ? '10' : '60' }}</span>
            <span class="text-sm/6 font-semibold text-gray-600">/{{ pricingPeriod === 'monthly' ? 'month' : 'year' }}</span>
          </p>
