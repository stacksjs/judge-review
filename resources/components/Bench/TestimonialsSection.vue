  ...
  <div class="relative isolate bg-white pb-32 pt-24 sm:pt-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm/6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
        <figure class="rounded-sm bg-[#f8f7f2] p-0.5 shadow-md xl:col-start-2 xl:row-end-1 sm:col-span-2">
          <div class="rounded-sm bg-white p-6 sm:p-8">
            <blockquote class="text-lg font-medium tracking-tight text-gray-900 sm:text-xl/8">
            ...
            <div class="mt-6 flex items-center gap-x-4 border-t border-gray-200 pt-4">
              <img class="size-10 rounded-full bg-gray-50" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=1024&h=1024&q=80" alt="">
              <div>
        ...
        <div class="space-y-8 xl:contents xl:space-y-0">
          <div class="space-y-8 xl:row-span-2">
            <figure class="rounded-sm bg-[#f8f7f2] p-0.5 shadow-md">
